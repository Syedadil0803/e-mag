...
export default defineConfig({
  resolve: {
    alias: {
      ...
      'easy-email-core': path.resolve('./node_modules/easy-email-core'),
      'easy-email-editor': path.resolve('./node_modules/easy-email-editor'),
      'easy-email-extensions': path.resolve('./node_modules/easy-email-extensions'),
    },
  },
  optimizeDeps: {},
  define: {},
